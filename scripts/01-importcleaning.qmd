...
According to the official course map and pictures from the television broadcast,
the mount/dismount line is between N53.592699 E10.022551 and N53.592679
E10.022634. To identify the race section of the files, we search for the
GPS-data within an area near these points.
...
```{r}
# Plot power data for each individual

plot_power <- function(i) {
  d <- d_sync[[i]]
  ggplot(d, aes(x = racetime, y = power)) +
    geom_line()
