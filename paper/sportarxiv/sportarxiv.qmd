...
We conducted the full data analysis in R Version 4.2.0. The Bayesian models were fitted using Stan Version 2.21.0 via the rstanarm package Version 2.21.3 [@goodrich2020]. This observational study was preregistered on [OSF](https://osf.io/rdb64/) and approved by the local ethics committee (196/2021). All data and code are available at [GitHub](https://github.com/smnnlt/trihamburg).
...
kableExtra::kbl(
  ...
  kableExtra::footnote(
  general = c("mean: Average Power, sd: Standard deviation; NP: Normalized Power;", "max: Maximum Power", " *Power data for athlete C is missing for the first of six laps. We","extrapolated the time and peaks over 500 W/700 W by multiplying", "the recorded data with the factor 1.2."),
  general_title = "",
